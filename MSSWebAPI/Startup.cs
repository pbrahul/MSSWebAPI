...
using MSSWebAPI.Middleware;
using MSSWebAPI.Policy;
using Utility;
...
namespace MSSWebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MSSWeb API", Version = "v1" });
            });
            ...
            JWTConfigaration(services);
            GetAllDepensency(services);
        }

        private void JWTConfigaration(IServiceCollection services)
        {
